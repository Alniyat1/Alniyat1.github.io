...
function showWelcome() {
  ...
  let dist = getDistance(102.84963500000003, 24.827134000000022, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("10/21/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| Alniyat🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Alniyat🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
if ((y == 2025 && m == 4 && dd == 5) || (y == 2026 && m == 4 && dd == 4) || (y == 2027 && m == 4 && dd == 4)) {//清明节
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("清明时节雨纷纷,一束鲜花祭故人💐");
    sessionStorage.setItem("isPopupWindow", "1");
  }
}
if ((y == 2024 && m == 12 && dd == 22) || (y == 2025 && m == 12 && dd == 21) || (y == 2026 && m == 12 && dd == 21)) {//冬至
  if (sessionStorage.getItem("isPopupWindow") != "1") {
    Swal.fire("冬至快乐\n快吃上一碗热热的汤圆和饺子吧🧆");
    sessionStorage.setItem("isPopupWindow", "1");
  }
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("10/21/2024 00:00:00");
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://assets.vviptuangou.com//uploads/touch/20241101/674493803fda3b9945f81cd0fd5858d3.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://assets.vviptuangou.com//uploads/touch/20241101/9cadd9a5e7ab07058b4f21d492f4f9d9.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://tuchuang.voooe.cn/images/2024/10/31/home_bg_01.webp);
    --darkmode-bg:url(https://tuchuang.voooe.cn/images/2024/10/31/home_bg_02.webp);
    --mobileday-bg: url(https://tuchuang.voooe.cn/images/2024/10/31/mobile_bg_01.webp);
    --mobilenight-bg: url(https://tuchuang.voooe.cn/images/2024/10/31/mobile_bg_02.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
